...
#include "TimedLogGamemode.h"
#include "TimedLogLoader.h"
#define print(text) if (GEngine) GEngine->AddOnScreenDebugMessage(-1, 1.5, FColor::Red,text)

ATimedLogGamemode::ATimedLogGamemode()
{
	// Turn on ticking
...
void ATimedLogGamemode::SendLog(FLogData SentLog)
{
...
void ATimedLogGamemode::SendTextLog(FLogDataText SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
void ATimedLogGamemode::SendIntLog(FLogDataInt SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
void ATimedLogGamemode::SendIntArrayLog(FLogDataIntArray SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
void ATimedLogGamemode::SendEventmarkerLog(FLogDataEventmarker SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
void ATimedLogGamemode::SendFloatLog(FLogDataFloat SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
void ATimedLogGamemode::SendFloatArrayLog(FLogDataFloatArray SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
void ATimedLogGamemode::SendVectorLog(FLogDataVector SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
void ATimedLogGamemode::SendVectorArrayLog(FLogDataVectorArray SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
void ATimedLogGamemode::SendGUIDLog(FLogDataGUID SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
void ATimedLogGamemode::SendUObjectIDsLog(FLogDataUE4ObjectArray SentLog)
{
	ActLogContinuous.Add(SentLog.GetLogString());
...
FString ATimedLogGamemode::GetUE4ObjectID(UObject *ActObject)
{
...
void ATimedLogGamemode::Tick(float DeltaSeconds)
{
...
void ATimedLogGamemode::InitGame(const FString & MapName, const FString & Options, FString & ErrorMessage)
{
...
void ATimedLogGamemode::StartPlay()
{
	Super::StartPlay();

}

void ATimedLogGamemode::EndPlay(const EEndPlayReason::Type EndPlayReason)
{

	Super::EndPlay(EndPlayReason);
}

void ATimedLogGamemode::WriteSessionDataHeader()
{
...
void ATimedLogGamemode::UpdateSaveStringWithSessionData()
{
...
void ATimedLogGamemode::WriteLog()
{
	if (ActLog.Num() > 0)
	{
...
void ATimedLogGamemode::WriteLogContinuous()
{
...
void ATimedLogGamemode::LoadLevel(FString LevelName, FString GameModePath) {
...
void ATimedLogGamemode::BeginDestroy()
{
	WriteLog();
	WriteLogContinuous();
	Super::BeginDestroy();
